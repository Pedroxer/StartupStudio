...
urlpatterns = [
    ...
    path('projects/team/<int:team_pk>', views.team_detailed_view, name='team_detailed'), # basically a template for a team's page
    ...
    path('projects/team/<int:team_pk>/applications', views.look_project_team_applicants, name='project_teams_applications'),
    path('projects/team/<int:team_pk>/applications/<int:entry_pk>/<str:new_status>', views.team_change_status_event_entry_view, name='team_accept_or_deny_applicant'),
    ...
    path('projects/<int:project_pk>/get_messages_ajax/<str:channel_pk>', views.AjaxGetMessages.as_view(), name='ajax_get_messages'),
